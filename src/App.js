          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
               ...
               <BookShelfList listTitle="Want to Read" books={this.state.books} onChangeBookShelf={this.onChangeBookShelf} />
               <BookShelfList listTitle="Read" books={this.state.books} onChangeBookShelf={this.onChangeBookShelf} />
              </div>
            </div>
